class RealProperty:
    ...
    def price_difference(self, compared_to: "RealProperty"):
        main_property = self.square_metres * self.price_per_sqm
        compared_property = compared_to.square_metres * compared_to.price_per_sqm
        return abs(main_property - compared_property)
    
    def more_expensive(self, compared_to: "RealProperty"):
        main_property = self.square_metres * self.price_per_sqm
        compared_property = compared_to.square_metres * compared_to.price_per_sqm
        return main_property > compared_property
